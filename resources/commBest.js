...
const commBestILs = {
    '1.1+': {
        ...
        topRuns: [
            ...
            [35.65, 45.75, 24.42, 63.50, 35.27, 34.78, 50.89, 81.06, 43.57, 52.60, 40.45, 53.18, 48.90, 40.24, 44.38, 56.85, 60.09, 111.22, 50.80], // GamerAttack27
        ...
        splits: [
            ['6:49.14', '13:50.19', '22:56.95'],
            ['6:52.86', '13:46.71', '23:06.76'],
            ['6:52.97', '13:55.69', '23:06.76'],
            ['6:49.05', '13:43.46', '22:55.50'],
            ['6:50.38', '13:52.62', '23:14.19'],
            ['6:55.24', '13:53.89', '23:14.05'],
            ['6:52.79', '14:00.62', '23:22.63'],
            ['6:53.59', '13:55.48', '23:18.03'],
    ...
    Legacy: {
        ...
        topRuns: [
            ...
            // [27, 37, 19, 59, 25, 28, 35, 50, 31, 31, 29, 14, 39, 30, 28, 42, 53, 89, 40], // Yuka
        ]
    },
    NMG: {
        name: 'NMG',
        ...
        shot2: 'spread',
        topRuns: [
            [38, 49, 30, 63, 38, 37, 55, 86, 61, 49, 40, 48, 53, 45, 43, 61, 60, 113, 53], // GamerAttack27
            ...
            [38, 49, 31, 64, 40, 41, 57, 85, 64, 54, 46, 52, 51, 46, 43, 63, 63, 118, 56], // myekul
        ]
    },
    'NMG P/S': {
        name: 'NMG',
